...
function createAdmitStatusMap(county) {
	...
	function onEachFeature(feature, layer) {
		...
		//Bind properties desired to popup
		//Only show counties that have GRE data
		if (feature.properties.Name && (feature.properties.Admitted || feature.properties.NotAdmitted || feature.properties.Waitlist) || feature.properties.Rejected || feature.properties.NoAction) {
		    layer.bindPopup("<br>" + feature.properties.Name + " County" + "<br/>" +
		            "<br>" + "<b>" + "Students Admitted : " + "<b>" + feature.properties.Admitted + "<br/>" +
		            "<br>" + "<b>" + "Students Not Admitted : " + "<b>" + feature.properties.NotAdmitted + "<br/>" +
		            "<br>" + "<b>" + "Students Waitlist : " + "<b>" + feature.properties.Waitlist + "<br/>" +
		            "<br>" + "<b>" + "Students Rejected : " + "<b>" + feature.properties.Rejected + "<br/>" +
                    "<br>" + "<b>" + "Students No Action :" + "<b>" + feature.properties.NoAction);
		} else
			layer.bindPopup(feature.properties.Name + " County" + "<br/>" +
